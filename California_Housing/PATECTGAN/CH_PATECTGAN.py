...
for model_name, model in models.items():
    ...
    results = synthetic_pipeline(model, X_vals, Y_vals, X_test, y_test, continuous_cols, num_synthetic_datasets=10)
...
excel_name = "California_Housing/PATECTGAN/CaliHousing_PATECTGAN_Results.xlsx"

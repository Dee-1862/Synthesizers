...
if __name__ == "__main__":
    ...
    row_cnt = df.shape[0]
    base_output_dir = "Combined_Cycle_Power_Plant/PATECTGAN"
    file_name = "CCPP_PATECTGAN_Results.xlsx"
    ...
    final_metrics_df, final_synthetic_data = patectgan_pipeline(
        df = df,

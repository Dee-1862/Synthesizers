...
if __name__ == "__main__":
    ...
    epsi = 1.0
    pre_epsi = 0.2
    base_output_dir = "Combined_Cycle_Power_Plant/Aggregate Seeded"
    file_name = "CCPP_AggregateSeeded_Results.xlsx"
    ...
    final_metrics_df, final_synthetic_data = aggregate_pipeline(
        df = df,

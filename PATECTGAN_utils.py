...
def synthetic_pipeline(df, target_variable, row_cnt, model, X_test, y_test, continuous_cols, categorical_cols, num_synthetic_datasets = 10):
...
def patectgan_pipeline(df, target_variable, models, base_output_dir, excel_file_name, row_cnt, categorical_cols, continuous_cols, num_synthetic_datasets = 2):
    """
    ...
    for model_name, model in models.items():
        ...
        results = synthetic_pipeline(df, target_variable, row_cnt, model, X_test, y_test, continuous_cols, categorical_cols, num_synthetic_datasets = num_synthetic_datasets)

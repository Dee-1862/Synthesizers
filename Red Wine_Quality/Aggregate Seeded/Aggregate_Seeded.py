...
def synthetic_pipeline(model, X_vals, Y_vals, X_test, y_test, num_synthetic_datasets = 10):
    ...
    for i in tqdm(range(num_synthetic_datasets), desc="Generating synthetic datasets", unit="dataset"):
        ...
        epsilon_val = 6.0  # Privacy budget (decrease for more privacy)
        ...
        df_no_target.fillna(df_no_target.mean(), inplace=True)
        block_print()
...
excel_name = "Wine_Quality/Aggregate Seeded/WQ_AggregateSeeded.xlsx"

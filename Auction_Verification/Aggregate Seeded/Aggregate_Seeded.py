...
print("##### Loading data.....")
target_variable = 'verification.time'
air_quality = fetch_ucirepo(id=713)
...
categorical_cols = ['verification.result']
...
excel_name = "Auction_Verification/Aggregate Seeded/AV_AggregateSeeded_Results.xlsx"
